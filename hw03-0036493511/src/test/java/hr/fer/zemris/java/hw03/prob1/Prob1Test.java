...
//	@Ignore
	...
	public void testMultipartInput() {
		// Test input which has parts which
		// are tokenized by different rules...
...
//	@Test
	public void testMultipartInput2() {
		Lexer lexer = new Lexer(" #678#678 a #jkk#");
		
		checkToken(lexer.nextToken(), new Token(TokenType.SYMBOL, Character.valueOf('#')));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "678"));
		checkToken(lexer.nextToken(), new Token(TokenType.SYMBOL, Character.valueOf('#')));
		checkToken(lexer.nextToken(), new Token(TokenType.NUMBER, Long.valueOf(678)));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "a"));
		checkToken(lexer.nextToken(), new Token(TokenType.SYMBOL, Character.valueOf('#')));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "jkk"));
		checkToken(lexer.nextToken(), new Token(TokenType.SYMBOL, Character.valueOf('#')));
