...
/**
 * Razred služi za stvaranje message digest-a pomoću SHA-1 algoritma te na taj
 * način štiti lozinku kako nikad nebi bila spremljena u orginalnom obliku.
 * 
 * @author Filip
 *
 */
public class Crypto {
	...
	/**
	 * Metoda koja izračunava SHA-1 datotečni digest zadane datoteke.
	 * 
	 * @param source
	 *            put do datoteke
	 * @return SHA-256 digest zadane lozinke
	 */
